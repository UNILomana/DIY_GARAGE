...
-- Tiempo de generación: 18-05-2022 a las 19:04:05
...
--
ALTER TABLE `bookings`
  MODIFY `Booking_Id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;
...
--
ALTER TABLE `purchase`
  MODIFY `Purchase_Id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
