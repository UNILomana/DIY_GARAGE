...
class Booking:
    ...
    def print(self):
        print(self.Id, self.User_Id, self.Cabin_Id, self.Date, self.Hours, self.Vehicle_Type,'Yes' if self.Employee_Help else 'No', self.Employee_Id, self.Use_Hours, self.Price)
